...
export default function team() {
    return (
        <div>
            ...
            <div className='ml-2 mt-10 mb-10 flex-wrap flex'><h1 className='text'>NOTHING IS OUTSIDE OF THEIR REACH. FROM CLASSIC CUTS TO DARING TRANSFORMATIONS, EVERY STRAND BECOMES A TESTAMENT TO THEIR BOUNDLESS CREATIVITY.</h1></div>
        </div>
